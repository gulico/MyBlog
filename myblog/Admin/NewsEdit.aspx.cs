...
public partial class Admin_Default2 : System.Web.UI.Page
{
    ...
    {  //分页程序
        ...
        string sqlString = "select * from News order by NewsID desc"; //列出所有博文，按id降序排序
        conn.Open();
    ...
    protected void lbtnNewsDelete_Click(object sender, CommandEventArgs e)
    {  //删除
        int ID = Convert.ToInt32(e.CommandName);  //CommandName='<%#Eval("NewsID") %>'
        SqlConnection conn = new SqlConnection(connString);
        conn.Open();
